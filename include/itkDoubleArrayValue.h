...
=========================================================================*/
#ifndef __itkDoubleArrayValue_h
#define __itkDoubleArrayValue_h
 ...
 *
 * \brief Holds the value of a DOUBLE_ARRAY ParameterValueType.
 *
 * \sa ParameterValue
 * */
...
public:
  ...
  void SetValue( const DoubleArrayType & value )
    {
    m_DoubleArray = value;
    }

private:
  DoubleArrayType m_DoubleArray;
};
